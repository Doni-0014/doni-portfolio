#!/usr/bin/env python
"""
Simple script to add your profile image to the portfolio.
Run this script and follow the prompts to upload your image.
"""
...
def add_profile_image():
    """Add a profile image to the PersonalInfo model."""
    ...
    try:
        ...
        print(f"🔧 Or manage it in admin: http://127.0.0.1:8000/admin")
